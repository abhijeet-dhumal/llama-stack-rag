#!/usr/bin/env python3
"""
Test script to verify LlamaStack telemetry integration
"""

import time
from frontend.streamlit.core.llamastack_client import LlamaStackClient

def test_telemetry_integration():
    """Test the telemetry integration"""
    print("🚀 Testing LlamaStack Telemetry Integration")
    print("=" * 50)
    ...
    try:
        ...
        print("\n" + "=" * 50)
        print("🏁 Telemetry integration test completed!")
