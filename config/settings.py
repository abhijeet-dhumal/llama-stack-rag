...
class Settings(BaseSettings):
    ...
    # Feast settings
    feast_repo_path: str = Field(default="feast_feature_repo", description="Path to Feast repository")
    feast_feature_view: str = Field(default="document_embeddings", description="Feast feature view name")
    
    # Milvus settings
    milvus_uri: str = Field(default="feast_feature_repo/data/online_store.db", description="Milvus-lite database file path")
    milvus_collection: str = Field(default="rag_document_embeddings", description="Milvus collection name")
    ...
    semantic_chunking: bool = Field(default=True, description="Enable semantic chunking")
    similarity_threshold: float = Field(default=0.3, description="Minimum similarity threshold for retrieval")
    ...
    # Processing settings
    max_context_chunks: int = Field(default=5, description="Maximum number of chunks for context")
    ...
    ollama_base_url: Optional[str] = Field(default=None, description="Custom Ollama base URL")
